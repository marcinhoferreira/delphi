...
type
   ...
   public
      ...
      function Add(AItemPedido: TWKItemPedido): Integer;
      property Items: TArrayWKItensPedido Read fItems Write fItems;
   end;
   ...
   private
      ...
      fCliente: TWKCliente;
      fValorTotal: Double;
      fItensPedido: TListaWKItensPedido;
      ...
      procedure SetValorTotal(const Value: Double);
      function GetItensPedido: TListaWKItensPedido;
      procedure SetItensPedido(const Value: TListaWKItensPedido);
   protected
      { Protected declarations }
   public
      { Public declarations }
      ...
      property ValorTotal: Double Read GetValorTotal Write SetValorTotal;
      property ItensPedido: TListaWKItensPedido Read GetItensPedido Write SetItensPedido;
   end;

   TArrayWKPedidos = Array Of TWKPedido;

   TListaWKPedidos = class(TObject)
   private
      { Private declarations }
      fItems: TArrayWKPedidos;
   protected
      { Protected declarations }
   public
      { Public declarations }
      function Tamanho: Integer;
      function Add(APedido: TWKPedido): Integer;
      property Items: TArrayWKPedidos Read fItems Write fItems;
   end;
...
begin
   ...
   fItensPedido :=  TListaWKItensPedido.Create;
end;
...
function TWKPedido.GetItensPedido: TListaWKItensPedido;
begin
   Result := fItensPedido;
end;
...
procedure TWKPedido.SetItensPedido(const Value: TListaWKItensPedido);
begin
   if Value <> fItensPedido then
      fItensPedido := Value;
end;
...
function TListaWKItensPedido.Add(AItemPedido: TWKItemPedido): Integer;
begin
   SetLength(fItems, Tamanho + 1);
   fItems[High(fItems)] := AItemPedido;
   Result := High(fItems);
end;

function TListaWKItensPedido.Tamanho: Integer;
begin
...
function TListaWKPedidos.Add(APedido: TWKPedido): Integer;
begin
   SetLength(fItems, Tamanho + 1);
...
function TListaWKPedidos.Tamanho: Integer;
begin
   Result := Length(fItems);
end;
